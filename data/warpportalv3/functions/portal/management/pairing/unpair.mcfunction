...
execute as @s at @s run function warpportalv3:portal/management/pairing/unpair/remove_pairing_data with entity @s ArmorItems[0].components."minecraft:custom_data".pairing